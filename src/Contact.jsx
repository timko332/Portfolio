      ...
      <div className="flex flex-col max-w-6xl w-full h-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mt-10">
            ...
            >
                <form 
                    method="POST" 
                    action="https://formsubmit.co/risteskitimotej@gmail.com"
                ...
                >
                    ...
                    <button className="text-white border-2 border-[#38bdf8] bg-[#38bdf8]/10 hover:bg-[#38bdf8] hover:text-[#0f172a] px-4 py-3 my-4 mx-auto flex items-center rounded-lg font-bold text-lg transition-all duration-300 w-full justify-center shadow-[0_0_15px_rgba(56,189,248,0.2)] hover:shadow-[0_0_25px_rgba(56,189,248,0.6)]">
                        {t.contact.btn}
                    </button>
                </form>
            </motion.div>
